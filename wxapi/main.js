...
const API_BASE_URL1 = 'https://api.it120.cc'
...
module.exports = {
  request,
  //登陆精略网校账号接口
  logininwangxiao: (data) => {
    return request('/wangxiao/login',true,'get',data)
  },

  //注册精略网校账号接口
  joinnowwangxiao: (data) => {
    return request('/wangxiao/joinnow',true,'get',data)
  },
  //验证码验证接口
  joinnowbysmscode: (data) => {
    return request('/wangxiao/joinnowbysmscode',true,'get',data)
  }
